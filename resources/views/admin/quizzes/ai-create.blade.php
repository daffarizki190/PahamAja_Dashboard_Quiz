                ...
                <div class="flex flex-col md:flex-row md:items-start justify-between gap-6">
                    <div>
                        <div class="flex items-center gap-2 text-slate-400 text-[10px] font-black uppercase tracking-widest">
                            ...
                            <span>/</span>
                            <span class="text-indigo-600">AI Generator</span>
                        </div>
                        <h2 class="text-4xl font-black text-slate-900 tracking-tight mt-3">Generate Quiz dengan AI</h2>
                        <p class="text-slate-500 mt-3 font-medium text-sm">Upload dokumen, pilih parameter, lalu biarkan AI membuat draft soal.</p>
                    </div>
                    <a href="{{ route('admin.quizzes.index') }}" class="bg-white border border-slate-200 text-slate-700 px-6 py-3 rounded-xl font-bold text-sm hover:bg-gray-50 transition-all flex items-center gap-2 h-fit w-fit shadow-sm">
