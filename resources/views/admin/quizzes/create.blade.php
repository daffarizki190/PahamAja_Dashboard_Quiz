    ...
    <div class="flex">
        ...
        <main class="flex-1 p-8">
            <header class="mb-10 flex justify-between items-center">
                <div>
                    <h2 class="text-3xl font-bold text-slate-800">Create New Quiz</h2>
                    <p class="text-slate-500">Design your assessment with questions and scoring rules.</p>
                </div>
                <a href="{{ route('admin.dashboard') }}" class="text-slate-500 hover:text-slate-800 font-semibold flex items-center">
